package cn.itcast.itcast.watermark;
 ...
 * 并使用AllowedLateness + 侧道输出 来单独处理迟到严重的数据
 *
 */
public class WatermarkDemo03 {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Order> orderDS = env.addSource(new SourceFunction<Order>() {
            ...
            public void run(SourceContext<Order> ctx) throws Exception {
                ...
                while (flag) {
                    ...
                    //随机模拟一些延迟(可能会很严重)
                    long eventTime = System.currentTimeMillis() - (1000 * ran.nextInt(20));
        ...
        //TODO 4.sink
        result.print("正常的没有迟到的数据的结果");
        //*4.取出迟到严重的数据
        DataStream latenessDS = result.getSideOutput(latenessTag);
        latenessDS.print("迟到严重的数据,后面可以自己根据需要想怎么处理就怎么处理");
